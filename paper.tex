...
expectations), to simplify the creation of custom dtypes, and to enable much
requested features such as units.  The new implementation should be simpler and
more cleanly implemented.
