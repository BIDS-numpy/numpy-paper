...
To coordinate work as a global community, to ensure accuracy of
computed results, and to allow modification without breakage, the
NumPy community pioneered best software engineering practices in the
scientific Python community.  For example, NumPy early on adopted
distributed revision control, unit testing, continuous integration,
code review, standardized executable documentation, ...
...
% From grant text/summary on Sloan website:
%
% to remove the technical debt and set in place standards and
% architecture to encourage more sustainable development
