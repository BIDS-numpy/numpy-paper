...
NumPy's is no longer \emph{just} the foundational array library underlying
...
microscopes and the LSST \cite{jenness2018lsst}.  New generation languages, interpreters, and compilers,
