...
More details about the \code{ndarray} data structure are given in ``The NumPy array:
...
Data analysis frequently involves operations $(+, -, \times, /, \log, \arctan, \dots)$ on
the individual measurements.
In programming languages such as C, this would involve looping over every element
...
These \emph{vectorized} operations often produce one-liners that would tens
