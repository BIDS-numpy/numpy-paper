...
\begin{figure}
  ...
  \caption{\textbf{Scientific Python Ecosystem.}
   This figure highlights (in blue) some of the essential tools and libraries that depend
...
For example, the \code{eht-imaging} library \cite{chael2019ehtim} developed by the Event Horizon Telescope 
