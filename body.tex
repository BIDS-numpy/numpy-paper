...
% our focus is ...
% NumPy purpose engages with this problem by ...
% [this also defines the scope of NumPy]
...
% \footnote{\url{https://mxnet.incubator.apache.org}}
% \footnote{\url{https://dask.org}}
% JAX has a citation, see https://github.com/google/jax#citing-jax
% Xarray has a citation, see http://xarray.pydata.org/en/stable/faq.html#how-should-i-cite-xarray 
...
% Ralf: FIXME I don't think this is actually important - should work exactly the same
% for users whether a NumPy-compatible API is a subclass or a duck array
Primarily, there
