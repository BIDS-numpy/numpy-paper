...
% KJM: agreed
% FIXME we should figure out if we want to keep working on the figures in this format or not
\begin{figure*}[h]
  \centering
...
%     purpose or not?
% KJM: yes, sort of, (a) corresponds to the two para above
% (b) corresponds to the next two para and
% (c) corresponds to the last two (or three) para
