...
languages for scientific computing like Yurik \cite{munro1995using} as well
...
build on NumPy mean that it has an unusually high need for stability. 
...
A second example is the rewrite of NumPy's random number generation facilities.
