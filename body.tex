...
SciPy and Matplotlib are tightly integrated with NumPy.
...
The combination of NumPy, SciPy, and Matplotlib with 
...
and makes interactive data exploration fluid and simple.
...
NumPy plays a coordinating role for the ecosystem of array-aware
libraries including setting documentation standards,
providing array testing infrastracture,
and coordinating minimum version depedencies.

Exposing this foundation for array programming, as well as the surrounding ecosystem of
tools, in IPython or Jupyter, creates an ideal environment for
interactive, exploratory data analysis where users iteratively inspect,
...
or narrative computational notebooks.
This rich and productive environment has made the scientific Python ecosystem popular for scientific
research.
As a result, important scientific software packages build on the ecosystem
further exanding it for specific research projects.
...
Similar examples can be found in physics, earth sciences, biology,
and more.
These researchers depend on NumPy being correct, reliable,
and repeatable.
...
This conflicts with the need to innovate;
...
% this leads to a proliferation of arrays  

\section*{Proliferation of arrays}

% pandas, xarray, ...
% distributed arrays, delayed execution arrays
% GPU arrays, tensor computation libraries
% sparse arrays
