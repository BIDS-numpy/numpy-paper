...
The NumPy array is a structure that efficiently stores and accesses $n$-dimensional arrays, also known as tensors \cite{vanderwalt2011numpy}, that enables a wide variety of scientific computation.  It consists of a pointer to memory, along with meta-data used to interpret the data stored there, notably a {\em data type}, {\em shape}, and {\em strides} (see Figure~\ref{fig:array-concepts}).
