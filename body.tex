...
for missing values or categorical data. % may be worth saying a few sentences about missing values
% if we want to discuss Pandas, perhaps we could do so here (i.e, missing values)
% maybe we need to rename the section, but this could anticipate
% the dtypes discussion below
...
geometrical objects \cite{pygeos}, and missing values. % pandas: categoricals, IP addresses?
