...
fast, and stable.
It is no longer a small community project, but is core scientific
infrastructure.
The developer culture has changed as well.
- Governance
- Process (NEP, roadmap, how we handle issues on GH, etc.)
- still primarily draw from graduate students and researchers
...
Over the next decade, we will face new challenges.
...
NumPy is poised to tackle these challenges, and florish in the next decade.
Need
- Next generation of developers (grad students) to sign on
- Funders and industry continue funding this project as well as increasing support for the ecosystem through new funding mechanisms.
