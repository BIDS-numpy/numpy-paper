...
subarrays or individual elements), {\em operators} (e.g., $+$, $-$, $\times$, and $/$
...
The scientific Python ecosystem \fixme{(Fig.)} is composed of many different libraries.
...
Employing these core array-aware libraries are widely used
technique-specific libraries\cite{SciPyProceedings_11}.
Finally, several domain-specific
libraries \cite{astropy:2013,astropy:2018,cock2009biopython,millman2007analysis,2018EGUGA..2012146H}
are built on this diverse foundation of tooling.
