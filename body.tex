...
% not sure where this goes, but it would be good to have something
% about dtype limitation in this section
While it supports a wide range of datatypes, it does not have good support
for missing values or categorical data.
% may be worth saying a few sentences about missing values and categorical data
