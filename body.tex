...
It plays an essential role in many research analysis pipelines in physics,
biology, ... % w/ citations
In particular, LIGO, EHT, Higgs-Boson, ...
...
NumPy consists of the \code{ndarray}-object along with utility functions to
operate on it.
...
worlds'' unification of the two projects.  %This became known as NumPy.
