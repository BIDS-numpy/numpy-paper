...
%At the time, commercial languages for interactive computing with numerical
%arrays were already well-established, including Matlab and IDL.
%They were developed and maintained by large groups of
%full-time professional programmers, supported by formal quality assurance,
%release managers, and writers of scientific documentation.
%In contrast, Numeric, and later NumPy, would continue to be developed almost
%entirely by scientists, including graduate students and faculty.
%%without specific funding and often to the detriment of their careers.
...
%NumPy had no dedicated funding, and development time
...
Over the next 10 years, NumPy attracted more scientist developers.
...
Another ongoing example is a redesign of the data type system.  Data types
...
%"""
%NumPy’s high level ndarray API has been implemented several times outside of
...
%
%Similarly there are many projects that build on top of the NumPy API for
...
%
%We would like to be able to use these libraries together, for example we would
