...
or an integrated development environment (IDEs) such as Spyder\cite{spyder2020}.
...
gate arrays (FPGAs).  Data sets routinely exceed the memory capacity of a single machine and may be stored on multiple machines or in
...
decides to try new technology, they must
...
from switching between NumPy arrays, GPU arrays, or distributed arrays, as appropriate.
...
easier to read array notation\cite{smith2014pep465}.
