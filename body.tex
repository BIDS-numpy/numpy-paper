...
It also performs accelerated linear algebra, utilising one of several backends
...
\begin{figure*}
  ...
  \caption{\textbf{Proliferation of Arrays.} Many ...}
...
- massive explosion in data science, machine learning, and artificial intelligence (tensors)
...
barrier to entry and provides stability to the community.
What can NumPy do to support the use of its API without blocking innovation?
We believe that improving interoperability by having NumPy be a central
coordinator among array objects is a good way to balance stability while
