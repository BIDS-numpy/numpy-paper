...
largest supercomputers, with performance
...
Importantly, some projects follow the NumPy API exactly---with Dask,
...
\begin{figure*}
  ...
  \caption{\textbf{Interoperability.} Through its array protocol, the NumPy API
     ...
     a Dask array, respectively. The call succeeds by dispatching to the
     appropriate library implementation, and results in different output array
     types.
